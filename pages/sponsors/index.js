      ...
      <div className='container' style={{ maxWidth: '680px' }}>
        <div className='row'>
          <div className='col'>
            ...
            <h2><StrongLink href='mailto:kamran@developer.guide?subject=Sponsoring developer.guide'>Everywhere Package</StrongLink></h2>
            ...
            <p>— Kamran (<StrongLink href='mailto:kamran@developer.guide?subject=Sponsoring developer.guide'>kamran@developer.guide</StrongLink>)</p>
          </div>
        </div>
      </div>
    </div>
